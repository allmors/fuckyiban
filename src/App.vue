<template>
  <div id="root">
    <div class="header">
      ...
      <div class="title home" v-if="page == 0">Fuck Yiban v0.0.1</div>
      <div class="title" v-if="page == -1">关于</div>
      <div class="title" v-else-if="page == 1">{{ studentName }}的请销假</div>
      <div class="title" v-else-if="page == 2">使用说明</div>
    ...
    <div class="content" v-if="page == 0">
      <div class="edit-title-detail">
        <div class="edit-title-detail-dot"></div>
        申请人
      </div>
      ...
      <div class="edit-detail-content">
        ...
        <br /><br />
        <p style="color:red">在此输入签名图片连接：</p>
        <div style="display: flex; width: 250px">
          <input type="text" v-model="imgSrc" placeholder="在此输入签名图片连接" />
          <!-- <button @click="saveImg">确定</button> -->
        </div>
      </div>
      <div class="edit-title-detail">
        <div class="edit-title-detail-dot"></div>
      ...
      <div class="edit-detail-content">
        ...
        <button
          class="add"
          @click="approvers.push({ name: '', id: '', time: '' })"
        >
          <img src="./assets/add.svg" />
        </button>
      </div>
    ...
    <div class="final" v-if="page == 0">
      ...
      <button @click="page = 2">使用说明</button>
    </div>
    <fake
      v-if="page == 1"
    ...
    <Instr v-if='page == 2' @exit='page=0' />
    <div class="about" v-if="page == -1">
      <img src="./assets/logo.png" />
      <h2>Fuck Yiban 0.0.1</h2>
...
import Instr from "./components/fake/instruction.vue";
